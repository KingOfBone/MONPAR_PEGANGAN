...
<div id="wrapper">
       ...
       <div id="page-wrapper" >
           ...
           <div class="row">
                ...
                <div class="col-md-2">
                    <a href="?<?php echo $foldernyah; ?>_tambah=<?php echo $nama_table; ?>" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-plus"></i>Tambah Data</a>
                    <br /><br />
                </div>
           </div>
           <div class="row">
									...
									?>
											<tr>
												...
												<?php
													foreach($kolom_table as $kol) {
														...
														if($cek_penting !== false)
															echo '<td>'. tampil_kolom_isitable('lihat', $kol['Kolom'], $kol['Tipe'], $nama_table, $row, $cek_fk) .'</td>';
													}
												?>
												...
												<td class="center">
													...
													-->
													<a href="?<?php echo $foldernyah; ?>_update=<?php echo $nama_table; ?>&&id=<?php echo $row['id']; ?>" type="button"><i class="fa fa-pencil-square-o fa-2x"></i></a>
													 <a href="#" id="mau_delete=<?php echo "$nama_table,$pk,$row[id],".$foldernyah."_lihat"; ?>" class="delete">
