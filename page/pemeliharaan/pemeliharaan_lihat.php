<?php
	...
	$sql = kumpulan_query_tampil_dibaris_awal($pk, $nama_table, null);
	$sql = mysql_query($sql);
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatabel">
									...
									?>
											<tr>
												...
												<td class="center">
													<a href="#" class="detail" data-id="<?php echo $row['id']; ?>" data-nama_table="<?php echo $nama_table; ?>" data-objek="tacometer" role="button" data-toggle="modal">
