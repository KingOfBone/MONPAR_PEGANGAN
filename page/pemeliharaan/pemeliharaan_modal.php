<?php
	...
	$sql = "
		select $nama_table.*, Apar.*, $pk 'id', Apar.id_apar 'fk' from $nama_table 
		inner join pengisian 
			on pengisian.kode_pengisian=$nama_table.kode_pengisian 
		inner join Apar 
...
<div class="row">
    ...
    <div class="col-md-3">
        <?php 
			...
			$gambar = $lihat_peta[0];
			$nama_gambar = "Tacometer Lantai $row[lantai] / $row[no_apar] / $row[penempatan]";
		?>
