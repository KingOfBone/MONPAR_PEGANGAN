           ...
           <div class="row">
                <div class="col-md-12">
                    <?php if(isset($_GET["sukseshapus"])){?>
						 ...
						 <?php }else if(isset($_GET["pesan_tambah"])){ ?>
						 <div class="alert alert-success">
							<a href='?apar_tambah'><?php echo $_GET['pesan_tambah']; ?> (klik saya)</a>
							<button aria-hidden="true" data-dismiss="alert" class="close" type="button">&times;</button>
						 </div>
									...
									?>
											<tr>
												...
												<td class="center">
													...
													<a href="?pemeliharaan_tambah&&id=<?php echo $row['id']; ?>" type="button"><i class="fa fa-check-circle fa-2x"></i></a>
