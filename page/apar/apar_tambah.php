					...
					<form id="validate-me-plz" name="form1" enctype="multipart/form-data" role="form" action="" method="post">
							...
							<?php
								...
								foreach($kolom_table as $key=>$kol) {
									...
									if($cek_fk !== false && $cek_hidden === false) {
												...
												<div class="row">
													...
													<div class="col-md-5">
														...
														<?php 
																...
																$i_gambar_dinamis++;
														?>
															<input type="file" class="form-control fileToUpload" id='gambar_dinamis_<?php echo $i_gambar_dinamis; ?>' name="<?php echo $kolom_asli; ?>" value="<?php echo $row[$kolom_asli]; ?>" />
