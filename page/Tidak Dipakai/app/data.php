<?php
$sql = mysql_query("SELECT * from app  ORDER BY namaapp asc ") or die (mysql_error());
...
<div id="wrapper">
       ...
       <div id="page-wrapper" >
           ...
           <div class="row">
                ...
                <div class="col-md-2">
                    <a href="?tambah-app" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-plus"></i>Tambah Data</a>
                    <br /><br />
                </div>
           </div>
           <div class="row">
                                    ...
                                    <?php
                            				...
                            				?>
                            					<tr>
                                                    ...
                                                    <td class="center">
                                                        <a href="?update-app=<?php echo $row["kodeapp"]?>" type="button"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                                                         <a href="#" id="delete-app=<?php echo $row["kodeapp"]?>" class="delete">
