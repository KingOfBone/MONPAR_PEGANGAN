...
mysql_query("DELETE FROM tabel_simpanan_sementara ") or die (mysql_error);  
    ...
    mysql_query("INSERT INTO tabel_history VALUES ('','$_SESSION[username]','','$date','setor simpanan konfirmasi bank','tambah')");
    ...
    foreach($idArr as $noAnggota1){
        ...
        mysql_query("INSERT INTO tabel_simpanan VALUES ('','','$noAnggota1','$tgl','$jmlsetor','Simpanan Wajib','setor','bank');") or die (mysql_error);
    }
