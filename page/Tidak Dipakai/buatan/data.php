<?php
$sql = mysql_query("SELECT * FROM buatan ORDER BY kodebuatan DESC ") or die (mysql_error());
...
<div id="wrapper">
       ...
       <div id="page-wrapper" >
           ...
           <div class="row">
                ...
                <div class="col-md-2">
                    <a href="?tambah-buatan" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-plus"></i>Tambah Data</a>
                    <br /><br />
                </div>
           </div>
           <div class="row">
                                    ...
                                    <?php
                            				...
                            				?>
                            					<tr>
                                                    ...
                                                    <td class="center">
                                                        <a href="?update-buatan=<?php echo $row["kodebuatan"]?>" type="button"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                                                        <a href="#" id="delete-buatan=<?php echo $row["kodebuatan"]?>" class="delete"><i class="fa fa-trash-o fa-2x"></i>
                                                        </a>
                                                    </td>
                            					</tr>
                            				<?php $no++; } ?>
