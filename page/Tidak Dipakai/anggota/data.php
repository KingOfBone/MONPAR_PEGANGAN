<?php
include "librari/class_paging_anggota.php";
if($_GET["sort"]==1){
...
FROM `tabel_anggota` a
WHERE $bagianWhere  $sort limit $posisi,$batas ") or die (mysql_error()); 
...
$(".iconpre").hide();
    ...
    $('#kliksaldoa , #kliksaldod , #kliknamea, #kliknamed').click(function(){
        $(".iconpre").slideToggle();
    });
...
<script>
  $(function() {
    $( "#keyword" ).autocomplete({
      source: 'assets/Actextbox/searchname.php'
    });
    $( "#nomor" ).autocomplete({
      source: 'assets/Actextbox/searchnip.php'
    });
  });
</script>
                            ...
                            ?>
                                ...
                                <form method="GET" action="?anggota">
                                    ...
                                    <div class="col-md-5" >
                                        ...
                                        <input id="anggota" class="form-control" name="anggota" value="" type="hidden"/>
                                        ...
                                        <tr>
                                            ...
                                            <th width="13%">
                                                ...
                                                <div class="pull-right">
                                                    <a id="kliknamea" class="pull-left" href="?anggota&sort=1"><img src="images/sortasc.png" class="img-responsive" /></a>
                                                    <a id="kliknamea" class="pull-right" href="?anggota&sort=2"><img src="images/sortdesc.png" class="img-responsive" /></a>
                                                </div>
                                            </th>
                      						<th  width="15%">
                                              <div class="pull-left">Saldo Simpanan</div>
                                              <div class="pull-right" >
                                                <a id="kliksaldoa" class="pull-left" href="?anggota&sort=3"><img src="images/sortasc.png" class="img-responsive" /></a>
                                                <a id="kliksaldod" class="pull-right" href="?anggota&sort=4"><img src="images/sortdesc.png" class="img-responsive" /></a>
                                              </div>
                                            </th>
                                            <th  width="15%">
                                            <div class="pull-left">Saldo Pinjaman</div> 
                                            <div class="pull-right" >
                                                <a id="klik5" class="pull-left" href="?anggota&sort=5"><img src="images/sortasc.png" class="img-responsive" /></a>
                                                <a id="klik6" class="pull-right" href="?anggota&sort=6"><img src="images/sortdesc.png" class="img-responsive" /></a>
                                            </div>
                                            </th>
                    				    ...
                    				    ?>
                            					<tr>
                                                    ...
                                                    <td class="text-right" >
                                                        ...
                                                        <?php echo number_format( $row["simpanan"], 0 , '' , '.' )."<br>";?></a>
                                                    </td>
                                                     <td class="text-right" >
                                ...
                                <div class="pager">
                                            	<?php
                                            	       if($_SESSION["level"]=="Us")
                                                        ...
                                                        {
                                                            $jmldata = mysql_num_rows(mysql_query("SELECT * FROM tabel_anggota WHERE $bagianWhere order by no_anggota ")); 
                                                        }   
