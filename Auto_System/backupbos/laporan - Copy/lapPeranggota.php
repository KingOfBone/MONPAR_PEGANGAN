    ...
    <div id="wrapper">
       ...
       <div id="page-wrapper" >
           ...
           <form method="POST" action="" id="validate-cari">
                <div class="col-md-12">
                    <div class="col-md-3"><p style="padding: 0;" class="">NIP / Nama </p></div>
                    <div class="col-md-6">
                        <div class="input-group custom-search-form">
                            <input id="skills" class="form-control" name="keyword" value="<?php if(isset($_POST["cari"])){ echo $_POST["keyword"]; }?>" data-rule-required="true" data-msg-required="data tidak boleh kosong" />
                    ...
                    <div class="col-md-3">
                        <?php if(isset($_POST["cari"])){ ?>
                            ...
                            <a target="_blank" href="page/laporan/cetak/lapCetakPeranggota.php?keycetak=<?php echo $key; ?>"><img class="img-responsive" src="images/excel.png" /></a>
