                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatabel">
									...
									?>
											<tr>
												...
												<td class="center">
													<a href="#" class="detail" data-id="<?php echo $row['id']; ?>" data-nama_table="<?php echo $nama_table_kecil; ?>" data-objek="apar" role="button" data-toggle="modal">
														<i class="glyphicon glyphicon-zoom-in fa-2x"></i>
													</a>
													<!--
													<a href="#" class="detail_peta" data-id="<?php echo $row['id']; ?>" data-nama_table="<?php echo $nama_table_kecil; ?>" data-objek2="lokasi" role="button" data-toggle="modal">
    ...
    <div class="modal-content" style="border-radius: 0;">
      <!-- dialog body -->
       <div class="modal-header bg-primary">
            ...
            <h4 class="modal-title">Detail Data <?php echo $nama_table_kecil; ?></h4>
       </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="border-radius: 0;">
      <!-- dialog body -->
       <div class="modal-header bg-primary">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Peta <?php echo $nama_table_kecil; ?></h4>
       </div>
